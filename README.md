...
🎁 **Accès libre jusqu'au 31 décembre 2027** : QualiCode s'utilise entièrement sans abonnement ni clé pendant cette période — toutes les fonctions sont ouvertes. Après cette date, l'essai gratuit de 5 jours démarre, puis l'abonnement s'applique. La bascule est automatique (`ACCES_LIBRE_JUSQU_AU` dans `js/license.js`).
